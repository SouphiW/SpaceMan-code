// Website : lovespaceman.club
// Telegram: t.me/SpaceMan_Club
// Twitter : twitter.com/SpaceMan_Club?s=05
/*
...
abstract contract SpaceMan {
    
    using SafeMath for uint256;

    string internal constant NAME = "SpaceMan";
    string internal constant SYMBOL = "SpaceMan";
    ...
    uint256 internal maxTransactionAmount = TOTAL_SUPPLY / 200;
    ...
    address internal marketingWallet = 0x96F5fcB31eD2Ac1337C48FB31dD4A0797921DC9A;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 25, marketingWallet);
    }
...
abstract contract BaseRfiToken is IBEP20, IBEP20Metadata, Ownable, Presaleable, SpaceMan, Pausable {
    ...
    function pause(bool enable) external onlyManager returns(bool){
        if(enable){
            _pause();
        }else{
            _unpause();
...
abstract contract Antiwhale is SpaceMan {
    function _getAntiwhaleFees(uint256, uint256) internal view returns (uint256){
        return sumOfFees;
    }
}

abstract contract SpaceManToken is BaseRfiToken, Liquifier, Antiwhale {
...
contract SpaceManV1 is SpaceManToken{

    constructor() SpaceManToken(Env.MainnetV2){
